...
<div style="height: 400px; width: 100%; max-width: 100%; background-color: white; overflow: hidden; border: 1px red">
    <div id="carouselExampleIndicatorsRec" class="carousel slide" data-bs-ride="carousel" data-bs-interval="3000">
        ...
        <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleIndicatorsRec" data-bs-slide="prev">
            <span class="arrow left" aria-hidden="true"></span>
            <span class="visually-hidden">Previous</span>
        </button>
        <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleIndicatorsRec" data-bs-slide="next">
